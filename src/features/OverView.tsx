...
const Overview = () => {
  ...
  const notes = [
    {
      id: 1,
      content: "Ideas for new marketing campaign",
      color: "#fdf4ff",
      date: "2023-09-14",
    },
    {
  ...
  return (
    <div className="bg-pink-50 rounded-lg p-6  shadow-md" style={paperStyle}>
      <div className="mb-6 relative">
        ...
        <p className="text-pink-600">
          Here's an overview of your planner stats
        </p>
      </div>
      <div
        className="bg-white rounded-lg p-6 text-gray-800 shadow-md border-2 border-pink-100"
        style={{
          backgroundImage:
      ...
      >
        <div className="flex items-center justify-between relative">
          ...
          <div>
            <h3
              className="font-medium mb-1 text-pink-800"
              style={handwrittenStyle}
            >
              “You don’t have to be great to start, but you have to start to be
              great.”
            </h3>
            <p className="text-pink-600 font-bro text-sm mb-4">-Zig Ziglar</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-lg p-4 shadow-sm border-2 border-pink-200">
          <div className="flex items-center mb-2">
            ...
            <h3 className="font-medium text-pink-800" style={handwrittenStyle}>
              Tasks
            </h3>
          </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border-2 border-blue-200">
          <div className="flex items-center mb-2">
            ...
            <h3 className="font-medium text-blue-800" style={handwrittenStyle}>
              Habits
            </h3>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div
          className="bg-white rounded-lg p-4 shadow-sm border-2 border-pink-100"
        ...
        >
          ...
          {tasks
            ...
            .map((task) => (
              <div
                key={task.id}
                className="mb-2 p-2 bg-white rounded-md shadow-sm border border-pink-100"
              >
        ...
        <div
          className="bg-white rounded-lg p-4 shadow-sm border-2 border-purple-100"
        ...
        >
          ...
          {notes.slice(0, 2).map((note) => (
            <div
              key={note.id}
              className="mb-2 p-3 rounded-md shadow-sm border border-purple-100"
